                        ...
                        _createClass(Iti, [ {
                            ...
                            value: function _translateCountryNames() {
                                for (var i = 0; i < this.countries.length; i++) {
                                    ...
                                    if (this.options.i18n.hasOwnProperty(iso)) this.countries[i].name = this.options.i18n[iso];
                                }
                            }
                        }, {
                            ...
                            value: function _initKeyListeners() {
                                ...
                                this._handleKeyEvent = function(e) {
                                    if (_this5._updateFlagFromNumber(_this5.telInput.value)) _this5._triggerCountryChange();
                                    if (e && e.data && /[^+0-9]/.test(e.data)) userOverrideFormatting = true; else if (!/[^+0-9]/.test(_this5.telInput.value)) userOverrideFormatting = false;
                            ...
                            value: function _bindDropdownListeners() {
                                ...
                                this._handleMouseoverCountryList = function(e) {
                                    ...
                                    if (listItem) _this8._highlightListItem(listItem, false);
                                };
                                this.countryList.addEventListener("mouseover", this._handleMouseoverCountryList);
                                this._handleClickCountryList = function(e) {
                                    var listItem = e.target.closest(".iti__country");
                                    if (listItem) _this8._selectListItem(listItem);
                                };
                                this.countryList.addEventListener("click", this._handleClickCountryList);
                                var isOpening = true;
                                this._handleClickOffToClose = function() {
                                    if (!isOpening) _this8._closeDropdown();
                                    isOpening = false;
                                };
                                ...
                                this._handleKeydownOnDropdown = function(e) {
                                    if ([ "ArrowUp", "ArrowDown", "Enter", "Escape" ].includes(e.key)) {
                                        e.preventDefault();
                                        e.stopPropagation();
                                        if (e.key === "ArrowUp" || e.key === "ArrowDown") _this8._handleUpDownKey(e.key); else if (e.key === "Enter") _this8._handleEnterKey(); else if (e.key === "Escape") _this8._closeDropdown();
                                    }
                                ...
                                if (this.options.countrySearch) {
                                    var doFilter = function doFilter() {
                                        ...
                                        if (inputQuery) _this8._filterCountries(inputQuery); else _this8._filterCountries("", true);
                                    };
                                    var keyupTimer = null;
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".case__slider")) new swiper_core_Swiper(".case__slider", {
                ...
                loop: true,
                navigation: {
                    prevEl: ".case__swiper-button-prev",
            ...
            if (document.querySelector(".testmonials__slider")) new swiper_core_Swiper(".testmonials__slider", {
                ...
                loop: true,
                navigation: {
                    prevEl: ".testmonials__swiper-button-prev",
                    nextEl: ".testmonials__swiper-button-next"
                },
                breakpoints: {
                    360: {
                        slidesPerView: 1,
